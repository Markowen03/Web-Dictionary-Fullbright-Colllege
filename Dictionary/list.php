        ...
        while ($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td class='text-center'>
                    <span>
                        <a class='btn btn-warning btn-sm' href='/Dictionary/edit.php?id=$row[id]' title='Edit'><i class='fa fa-pencil-square-o fa-lg'></i></a>
                    </span>
                </td>
                <td class='text-center'>
                    <span>
                        <a class='btn btn-danger btn-sm delete-button' href='#' data-id='$row[id]' title='Delete'><i class='fa fa-trash-o fa-lg'></i></a>
                    </span>
                </td>
            </tr>
            ";
